...
class MetaLearner:
    ...
    def loss_and_grad(
        ...
        :param params: A Pytree of parameters.
        :param xs: A batch of observations, stacked on the first dimension of the leaves.
        :return: A tuple containing the average loss of the batch (an array of shape ``()``), its gradient with respect to the parameters
            (a Pytree of the same shape as ``params``), and the loss tree."""
    ...
    def loss_and_per_example_grad(
        ...
        :param params: A Pytree of parameters.
        :param xs: A batch of observations, stacked on the first dimension of the leaves.
        :return: A tuple containing the average loss of the batch (an array of shape ``()``) the *per-instance* gradient with respect to the parameters
            (a stack of Pytrees of the same shape as ``params``, stacked on the first dimension of the leaves), , and the loss tree.
        """
