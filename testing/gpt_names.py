...
from gallimimus.training.configs import TrainingConfig, OptimizerConfig, \
    CheckpointConfig
...
text_codec = TextCodec(
    embed_dim=EMBED_DIM, n_tokens=N_TOKENS, max_length=MAX_LENGTH,
...
output_dir = os.path.join(
    save_dir, "dp_training"
) if TRAIN_DP else os.path.join(
    save_dir, 'standard_training',
)
